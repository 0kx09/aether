...
export default function CheckoutPage() {
  ...
  const total = shippingCost + expressCost;
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Save email to sessionStorage for success page
      if (formData.email) {
      ...
      <div className="mx-auto max-w-2xl pb-32">
        ...
        {currentStep === "payment" && (
          <div className="space-y-3 p-4 sm:p-6">
            ...
            <div className="rounded-xl bg-white p-4 sm:p-6">
              ...
              <div className="mt-4 flex gap-3">
                ...
                <button
                  ...
                  className={`flex flex-1 flex-col items-center gap-2 rounded-xl border-2 p-4 transition-colors ${
                    paymentMethod === "applepay" ? "border-black bg-gray-50" : "border-gray-200"
                  }`}
                >
            ...
            {paymentMethod === "card" && (
              <div className="rounded-xl bg-white p-4 sm:p-6">
                <h2 className="text-base font-semibold text-gray-900 sm:text-lg">Card Details</h2>
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`mt-1.5 w-full rounded-xl border px-4 py-3 text-sm outline-none transition-colors ${
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-medium text-gray-700 sm:text-sm">Expiry Date</label>
                      <input
                        type="text"
                        inputMode="numeric"
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-700 sm:text-sm">CVV</label>
                      <input
                        type="text"
                        inputMode="numeric"
                        value={formData.cvv}
                  ...
                  <div>
                    <label className="text-xs font-medium text-gray-700 sm:text-sm">Name on Card</label>
                    <input
                      type="text"
              ...
              <div className="rounded-xl bg-white p-4 sm:p-6">
                <div className="flex flex-col items-center py-8">
                  <p className="text-sm text-gray-600">
                    You&apos;ll be redirected to {paymentMethod === "paypal" ? "PayPal" : "Apple Pay"} to complete your payment.
                  </p>
                </div>
              </div>
            )}
            ...
            {/* Security Notice */}
            <div className="flex items-center justify-center gap-2 rounded-xl bg-green-50 p-4">
          ...
          <div className="space-y-4 p-4 sm:p-6">
            ...
            <div className="rounded-xl bg-white p-4 sm:p-6">
              ...
              <div className="mt-3 flex items-center gap-3">
                {paymentMethod === "card" ? (
                  <>
                    <div className="flex h-8 w-12 items-center justify-center rounded bg-gray-100 text-xs font-bold text-blue-600">
                      VISA
                    </div>
